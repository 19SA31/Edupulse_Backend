...
class UserRepository extends BaseRepository<IUser> implements IUserRepository {
  ...
  async updateProfile(userId: string, updateData: UpdateProfileData): Promise<IUser | null> {
  ...
  async findByPhoneExcludingId(phone: string, excludeId: string): Promise<IUser | null> {
